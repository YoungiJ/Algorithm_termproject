  ...
  const searchWords = ["화리화리 가천대점","호식당","복정로10술집",'봉구통닭','겐코','알촌','티코스커피','태평돈가스',
  '이디야커피','모퉁','다이소','뚜레쥬르','비전타워','제2학생생활관','글로벌센터','공과대학1','공과대학2','예술체육대학1','예술체육대학2',
  '전자정보도서관','중앙도서관','반도체대학','산학협력관1','교육대학원',"가천관", "AI공학관"]; // 검색 가능한 단어 목록
